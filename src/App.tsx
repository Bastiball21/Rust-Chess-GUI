      ...
      <div className="flex-1 flex flex-col p-4 gap-4 bg-gray-900 overflow-hidden">
        ...
        <div className="grid grid-cols-3 gap-4 h-[70vh] min-h-0">
          ...
          <div className="flex flex-col gap-2 items-center justify-center bg-gray-800 rounded-lg p-4 border border-gray-700 shadow-lg relative">
             ...
             <div className="w-full grid grid-cols-[auto_minmax(0,1fr)_auto] gap-4 items-end px-8 mb-2">
                 ...
                 <div className="flex flex-col gap-1 min-w-0 px-2">
                    <div className="flex items-start gap-2 min-w-0">
                      ...
                      <span className="text-white font-bold text-xl text-left break-words">{activeBlackStats.name}</span>
                    </div>
                 ...
                 <div className="flex items-center justify-end font-mono text-sm text-gray-400 shrink-0 px-2">
             ...
             <div className="w-full grid grid-cols-[auto_minmax(0,1fr)_auto] gap-4 items-start px-8 mt-2">
                 <span className="text-gray-400 font-mono text-sm text-left">WHITE</span>
                 <div className="flex flex-col gap-1 min-w-0 px-2">
                    <div className="flex items-start gap-2 min-w-0">
                      <Flag code={activeWhiteStats.country_code} />
                      <span className="text-white font-bold text-xl text-left break-words">{activeWhiteStats.name}</span>
                    </div>
                    <div className="flex items-center gap-2 font-mono text-sm text-gray-400">
